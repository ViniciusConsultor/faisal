  ...
  End Sub
    ...
    Private Sub OkButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OkButton.Click
      ...
      For I As Int32 = 0 To _SearchOptionDetailDataTable.Rows.Count - 1
        If _SearchOptionDetailDataTable(I).IsHidden Then
          If _SearchOptionDetailDataTable(I).ColumnName.ToLower.IndexOf(_CompanyDataTable.Co_IdColumn.ColumnName.ToLower) >= 0 Then
            _Query &= _SearchOptionDetailDataTable(I).ColumnName & "=" & Me.LoginInfoObject.CompanyID.ToString & " AND "

          ElseIf _SearchOptionDetailDataTable(I).ColumnName.ToLower.IndexOf(_DocumentTypeDataTable.DocumentType_IDColumn.ColumnName.ToLower) >= 0 Then
