        ...
        Else
          ...
          For I As Int32 = 0 To _DataTable.Rows.Count - 1
            With _DataTable.Rows(I).Item(_ColumnNameForComboBoxes)
              'Current value length must be equal to the length of mask so that valid values are added.
              If .ToString.Length = _MaskForCode.Length AndAlso Not _Collection.Contains(.ToString.Substring(_StartIndex, _Length)) Then
