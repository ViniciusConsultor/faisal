  ...
  Private Shared Sub GetUpgradeScripts(ByVal ExistingDbVersionpara As String, ByRef _UpgradingTo As String, ByRef _UpgradingScript As ArrayList)
    Try
      ...
      Select Case ExistingDbVersionpara
        Case "2.3.3.42"
          _UpgradingTo = "2.3.3.43"
          _UpgradingScript = New ArrayList(Common.SplitStringToArrayList(My.Resources.upgrade_02_03_03_42_to_02_03_03_43, Environment.NewLine & "go" & Environment.NewLine, False))
        Case "2.3.3.41"
          _UpgradingTo = "2.3.3.42"
          _UpgradingScript = New ArrayList(Common.SplitStringToArrayList(My.Resources.upgrade_02_03_03_41_to_02_03_03_42, Environment.NewLine & "go" & Environment.NewLine))
        Case "2.3.3.40"
          _UpgradingTo = "2.3.3.41"
          _UpgradingScript = New ArrayList
        Case "2.3.3.40"
          _UpgradingTo = "2.3.3.41"
          _UpgradingScript = New ArrayList
        Case "2.3.2.39"
          _UpgradingTo = "2.3.3.40"
          _UpgradingScript = New ArrayList(Common.SplitStringToArrayList(My.Resources.upgrade_02_03_02_39_to_02_03_03_40, Environment.NewLine & "go" & Environment.NewLine))
        Case "2.3.2.38"
          _UpgradingTo = "2.3.2.39"
          _UpgradingScript = New ArrayList(Common.SplitStringToArrayList(My.Resources.upgrade_02_03_02_38_to_02_03_02_39, Environment.NewLine & "go" & Environment.NewLine))
        Case "2.3.2.37"
          _UpgradingTo = "2.3.2.38"
          _UpgradingScript = New ArrayList(Common.SplitStringToArrayList(My.Resources.upgrade_02_03_02_37_to_02_03_02_38, Environment.NewLine & "go" & Environment.NewLine))
        Case "2.3.2.36"
        ...
        Case "2.3.2.33"
          _UpgradingTo = "2.3.2.34"
          _UpgradingScript = New ArrayList(Common.SplitStringToArrayList(My.Resources.upgrade_02_03_02_33_to_02_03_02_34, Environment.NewLine & "go" & Environment.NewLine))
        Case "2.3.2.32"
