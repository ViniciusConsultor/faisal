...
Public Class StockReport_old
    ...
    Public Property FullResourceName() As String
        Get
            Return "QuickReports.StockReport_old.rpt"
        End Get
...
Public Class CachedStockReport_old
    Inherits Component
    ...
    '    Dim rpt As StockReport_old = New StockReport_old()
    '    rpt.Site = Me.Site
    '    Return rpt
    'End Function
