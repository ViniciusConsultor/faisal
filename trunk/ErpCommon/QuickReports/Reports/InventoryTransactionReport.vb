...
Public Class InventoryTransactionReport
    ...
    Public Property FullResourceName() As String
        Get
            Return "QuickReports.InventoryTransactionReport.rpt"
        End Get
...
Public Class CachedInventoryTransactionReport
    Inherits Component
    ...
    '    Dim rpt As InventoryTransactionReport = New InventoryTransactionReport()
    '    rpt.Site = Me.Site
    '    Return rpt
    'End Function
