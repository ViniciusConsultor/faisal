...
Public Class ItemLedgerReport
    ...
    Public Property FullResourceName() As String
        Get
            Return "QuickReports.ItemLedgerReport.rpt"
        End Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WithValue() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedItemLedgerReport
    Inherits Component
    ...
    '    Dim rpt As ItemLedgerReport = New ItemLedgerReport()
    '    rpt.Site = Me.Site
    '    Return rpt
    'End Function
