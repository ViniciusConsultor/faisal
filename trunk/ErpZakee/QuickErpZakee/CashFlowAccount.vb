...
#Region "Declarations"
  ...
  Private _CashFlowAccountTableAdapterObject As New AccountsDataSetTableAdapters.Accounting_CashFlowAccountTableAdapter   'AccountingDataSetTableAdapters.Accounting_CashFlowAccountTableAdapters
  Private _CompanyTableAdapterObject As New QuickDAL.QuickCommonDataSetTableAdapters.CompanyTableAdapter
  Private _CashFlowAccountDataTable As New AccountsDataSet.Accounting_CashFlowAccountDataTable
  Private _CurrentCashFlowAccountDataRow As AccountsDataSet.Accounting_CashFlowAccountRow
    ...
    Try
      If IsValid() Then
        If Me._CurrentCashFlowAccountDataRow Is Nothing Then
          _CurrentCashFlowAccountDataRow = Me._CashFlowAccountDataTable.NewAccounting_CashFlowAccountRow
