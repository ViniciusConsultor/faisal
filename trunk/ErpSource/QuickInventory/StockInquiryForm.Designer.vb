...
Partial Class StockInquiryForm
  Inherits QuickBaseForms.ParentToolbarForm
    ...
    Me.StockQuickSpread = New QuickControls.Quick_Spread()
    Me.StockQuickSpread_Sheet1 = New FarPoint.Win.Spread.SheetView()
    ...
    Me.MinimumStockLevelQuickSpread = New QuickControls.Quick_Spread()
    Me.MinimumStockLevelSheet = New FarPoint.Win.Spread.SheetView()
  ...
  End Sub
  Friend WithEvents StockQuickSpread_Sheet1 As FarPoint.Win.Spread.SheetView
  ...
  Friend WithEvents StockQuickSpread As QuickControls.Quick_Spread
  Friend WithEvents MinimumStockLevelQuickSpread As QuickControls.Quick_Spread
  Friend WithEvents MinimumStockLevelSheet As FarPoint.Win.Spread.SheetView
