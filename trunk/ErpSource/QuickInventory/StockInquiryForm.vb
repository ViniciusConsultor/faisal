...
#Region "Methods"
  ...
  ''' </summary>
  Private Sub SetGridLayout(ByRef QuickSpreadSheet As FarPoint.Win.Spread.SheetView, ByVal _StockInquiryTable As QuickDAL.QuickInventoryDataSet.StockInquiryDataTable)
    Try
