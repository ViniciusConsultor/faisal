...
Public Class General
    ...
    Get
      Try
        If _Configuration Is Nothing Then
          If My.Computer.FileSystem.FileExists(My.Application.Info.DirectoryPath & "\" & Constants.CONFIG_FILE_NAME) Then
            _Configuration = New LogicalDataSet.ConfigurationDataTable
            _Configuration.ReadXml(My.Application.Info.DirectoryPath & "\" & Constants.CONFIG_FILE_NAME)
          Else
            _Configuration = New LogicalDataSet.ConfigurationDataTable
          End If
        End If
  ...
  Public Shared Sub ConfigurationWrite(ByVal _Key As String, ByVal _Value As String)
    Try
      ...
      ConfigurationTable.WriteXml(My.Application.Info.DirectoryPath & "\" & Constants.CONFIG_FILE_NAME)
    Catch ex As Exception
