...
Partial Public Class QuickAccountingDataSet
    ...
    Partial Public Class VoucherDetailDataTable
        Inherits Global.System.Data.TypedTableBase(Of VoucherDetailRow)
    ...
    Partial Public Class VoucherTypeDataTable
        Inherits Global.System.Data.TypedTableBase(Of VoucherTypeRow)
    ...
    Partial Public Class FinancialAccountTypeDataTable
        Inherits Global.System.Data.TypedTableBase(Of FinancialAccountTypeRow)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddFinancialAccountTypeRow(ByVal FinancialAccountType_ID As Short, ByVal FinancialAccountType_Desc As String, ByVal Stamp_UserID As Integer, ByVal Stamp_DateTime As Date, ByVal Upload_DateTime As Date, ByVal RecordStatus_ID As Integer) As FinancialAccountTypeRow
            Dim rowFinancialAccountTypeRow As FinancialAccountTypeRow = CType(Me.NewRow,FinancialAccountTypeRow)
            Dim columnValuesArray() As Object = New Object() {FinancialAccountType_ID, FinancialAccountType_Desc, Stamp_UserID, Stamp_DateTime, Upload_DateTime, RecordStatus_ID}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByFinancialAccountType_ID(ByVal FinancialAccountType_ID As Short) As FinancialAccountTypeRow
            Return CType(Me.Rows.Find(New Object() {FinancialAccountType_ID}),FinancialAccountTypeRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnRecordStatus_ID = New Global.System.Data.DataColumn("RecordStatus_ID", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnRecordStatus_ID)
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnFinancialAccountType_ID}, true))
            Me.columnFinancialAccountType_ID.AllowDBNull = false
            Me.columnFinancialAccountType_ID.Unique = true
    ...
    Partial Public Class CashFlowAccountDataTable
        Inherits Global.System.Data.TypedTableBase(Of CashFlowAccountRow)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCashFlowAccountRow(ByVal CashFlowAccount_ID As Short, ByVal CashFlowAccount_Desc As String, ByVal Stamp_UserID As Integer, ByVal Stamp_DateTime As Date, ByVal Upload_DateTime As Date, ByVal RecordStatus_ID As Integer) As CashFlowAccountRow
            Dim rowCashFlowAccountRow As CashFlowAccountRow = CType(Me.NewRow,CashFlowAccountRow)
            Dim columnValuesArray() As Object = New Object() {CashFlowAccount_ID, CashFlowAccount_Desc, Stamp_UserID, Stamp_DateTime, Upload_DateTime, RecordStatus_ID}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByCashFlowAccount_ID(ByVal CashFlowAccount_ID As Short) As CashFlowAccountRow
            Return CType(Me.Rows.Find(New Object() {CashFlowAccount_ID}),CashFlowAccountRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnRecordStatus_ID = New Global.System.Data.DataColumn("RecordStatus_ID", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnRecordStatus_ID)
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnCashFlowAccount_ID}, true))
            Me.columnCashFlowAccount_ID.AllowDBNull = false
            Me.columnCashFlowAccount_ID.Unique = true
...
Namespace QuickAccountingDataSetTableAdapters
    ...
    Partial Public Class FinancialAccountTypeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Accounting_FinancialAccountType] WHERE (([FinancialAccountType_ID] ="& _ 
                " @Original_FinancialAccountType_ID) AND ([FinancialAccountType_Desc] = @Original"& _ 
                "_FinancialAccountType_Desc) AND ((@IsNull_Stamp_UserID = 1 AND [Stamp_UserID] IS"& _ 
                " NULL) OR ([Stamp_UserID] = @Original_Stamp_UserID)) AND ((@IsNull_Stamp_DateTim"& _ 
                "e = 1 AND [Stamp_DateTime] IS NULL) OR ([Stamp_DateTime] = @Original_Stamp_DateT"& _ 
                "ime)) AND ((@IsNull_Upload_DateTime = 1 AND [Upload_DateTime] IS NULL) OR ([Uplo"& _ 
                "ad_DateTime] = @Original_Upload_DateTime)) AND ((@IsNull_RecordStatus_ID = 1 AND"& _ 
                " [RecordStatus_ID] IS NULL) OR ([RecordStatus_ID] = @Original_RecordStatus_ID)))"& _ 
                ""
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_FinancialAccountType_ID", Global.System.Data.SqlDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "FinancialAccountType_ID", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Accounting_FinancialAccountType] ([FinancialAccountType_ID], [Financ"& _ 
                "ialAccountType_Desc], [Stamp_UserID], [Stamp_DateTime], [Upload_DateTime], [Reco"& _ 
                "rdStatus_ID]) VALUES (@FinancialAccountType_ID, @FinancialAccountType_Desc, @Sta"& _ 
                "mp_UserID, @Stamp_DateTime, @Upload_DateTime, @RecordStatus_ID);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Financi"& _ 
                "alAccountType_ID, FinancialAccountType_Desc, Stamp_UserID, Stamp_DateTime, Uploa"& _ 
                "d_DateTime, RecordStatus_ID FROM Accounting_FinancialAccountType WHERE (Financia"& _ 
                "lAccountType_ID = @FinancialAccountType_ID)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@FinancialAccountType_ID", Global.System.Data.SqlDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "FinancialAccountType_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Accounting_FinancialAccountType] SET [FinancialAccountType_ID] = @Financi"& _ 
                "alAccountType_ID, [FinancialAccountType_Desc] = @FinancialAccountType_Desc, [Sta"& _ 
                "mp_UserID] = @Stamp_UserID, [Stamp_DateTime] = @Stamp_DateTime, [Upload_DateTime"& _ 
                "] = @Upload_DateTime, [RecordStatus_ID] = @RecordStatus_ID WHERE (([FinancialAcc"& _ 
                "ountType_ID] = @Original_FinancialAccountType_ID) AND ([FinancialAccountType_Des"& _ 
                "c] = @Original_FinancialAccountType_Desc) AND ((@IsNull_Stamp_UserID = 1 AND [St"& _ 
                "amp_UserID] IS NULL) OR ([Stamp_UserID] = @Original_Stamp_UserID)) AND ((@IsNull"& _ 
                "_Stamp_DateTime = 1 AND [Stamp_DateTime] IS NULL) OR ([Stamp_DateTime] = @Origin"& _ 
                "al_Stamp_DateTime)) AND ((@IsNull_Upload_DateTime = 1 AND [Upload_DateTime] IS N"& _ 
                ...
                "rdStatus_ID)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT FinancialAccountType_ID, FinancialAccountType_Desc, Stam"& _ 
                "p_UserID, Stamp_DateTime, Upload_DateTime, RecordStatus_ID FROM Accounting_Finan"& _ 
                "cialAccountType WHERE (FinancialAccountType_ID = @FinancialAccountType_ID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@FinancialAccountType_ID", Global.System.Data.SqlDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "FinancialAccountType_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     FinancialAccountType_ID, FinancialAccountType_Desc, Stamp_UserID, Stam"& _ 
                "p_DateTime, Upload_DateTime, RecordStatus_ID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Accounting_FinancialA"& _ 
                "ccountType"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_FinancialAccountType_ID As Short, ByVal Original_FinancialAccountType_Desc As String, ByVal Original_Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Original_Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Original_Upload_DateTime As Global.System.Nullable(Of Date), ByVal Original_RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_FinancialAccountType_ID,Short)
            If (Original_FinancialAccountType_Desc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_FinancialAccountType_Desc")
            Else
                Me.Adapter.DeleteCommand.Parameters(1).Value = CType(Original_FinancialAccountType_Desc,String)
            End If
            If (Original_Stamp_UserID.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_Stamp_UserID.Value,Integer)
            Else
            ...
            If (Original_Stamp_DateTime.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_Stamp_DateTime.Value,Date)
            Else
            ...
            If (Original_RecordStatus_ID.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(9).Value = CType(Original_RecordStatus_ID.Value,Integer)
            Else
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(9).Value = Global.System.DBNull.Value
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal FinancialAccountType_ID As Short, ByVal FinancialAccountType_Desc As String, ByVal Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Upload_DateTime As Global.System.Nullable(Of Date), ByVal RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(FinancialAccountType_ID,Short)
            If (FinancialAccountType_Desc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("FinancialAccountType_Desc")
            Else
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(FinancialAccountType_Desc,String)
            End If
            If (Stamp_UserID.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(Stamp_UserID.Value,Integer)
            Else
                Me.Adapter.InsertCommand.Parameters(2).Value = Global.System.DBNull.Value
            End If
            If (Stamp_DateTime.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(Stamp_DateTime.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FinancialAccountType_ID As Short, ByVal FinancialAccountType_Desc As String, ByVal Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Upload_DateTime As Global.System.Nullable(Of Date), ByVal RecordStatus_ID As Global.System.Nullable(Of Integer), ByVal Original_FinancialAccountType_ID As Short, ByVal Original_FinancialAccountType_Desc As String, ByVal Original_Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Original_Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Original_Upload_DateTime As Global.System.Nullable(Of Date), ByVal Original_RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(FinancialAccountType_ID,Short)
            If (FinancialAccountType_Desc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("FinancialAccountType_Desc")
            Else
                Me.Adapter.UpdateCommand.Parameters(1).Value = CType(FinancialAccountType_Desc,String)
            End If
            If (Stamp_UserID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Stamp_UserID.Value,Integer)
            Else
                Me.Adapter.UpdateCommand.Parameters(2).Value = Global.System.DBNull.Value
            End If
            If (Stamp_DateTime.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Stamp_DateTime.Value,Date)
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_FinancialAccountType_ID,Short)
            If (Original_FinancialAccountType_Desc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_FinancialAccountType_Desc")
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_FinancialAccountType_Desc,String)
            End If
            If (Original_Stamp_UserID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_Stamp_UserID.Value,Integer)
            Else
            ...
            If (Original_Stamp_DateTime.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_Stamp_DateTime.Value,Date)
            Else
            ...
            If (Original_RecordStatus_ID.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_RecordStatus_ID.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FinancialAccountType_Desc As String, ByVal Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Upload_DateTime As Global.System.Nullable(Of Date), ByVal RecordStatus_ID As Global.System.Nullable(Of Integer), ByVal Original_FinancialAccountType_ID As Short, ByVal Original_FinancialAccountType_Desc As String, ByVal Original_Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Original_Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Original_Upload_DateTime As Global.System.Nullable(Of Date), ByVal Original_RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_FinancialAccountType_ID, FinancialAccountType_Desc, Stamp_UserID, Stamp_DateTime, Upload_DateTime, RecordStatus_ID, Original_FinancialAccountType_ID, Original_FinancialAccountType_Desc, Original_Stamp_UserID, Original_Stamp_DateTime, Original_Upload_DateTime, Original_RecordStatus_ID)
        End Function
    End Class
    ...
    Partial Public Class CashFlowAccountTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Accounting_CashFlowAccount] WHERE (([CashFlowAccount_ID] = @Original"& _ 
                "_CashFlowAccount_ID) AND ([CashFlowAccount_Desc] = @Original_CashFlowAccount_Des"& _ 
                "c) AND ((@IsNull_Stamp_UserID = 1 AND [Stamp_UserID] IS NULL) OR ([Stamp_UserID]"& _ 
                " = @Original_Stamp_UserID)) AND ((@IsNull_Stamp_DateTime = 1 AND [Stamp_DateTime"& _ 
                "] IS NULL) OR ([Stamp_DateTime] = @Original_Stamp_DateTime)) AND ((@IsNull_Uploa"& _ 
                "d_DateTime = 1 AND [Upload_DateTime] IS NULL) OR ([Upload_DateTime] = @Original_"& _ 
                "Upload_DateTime)) AND ((@IsNull_RecordStatus_ID = 1 AND [RecordStatus_ID] IS NUL"& _ 
                "L) OR ([RecordStatus_ID] = @Original_RecordStatus_ID)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CashFlowAccount_ID", Global.System.Data.SqlDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CashFlowAccount_ID", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Accounting_CashFlowAccount] ([CashFlowAccount_ID], [CashFlowAccount_"& _ 
                "Desc], [Stamp_UserID], [Stamp_DateTime], [Upload_DateTime], [RecordStatus_ID]) V"& _ 
                "ALUES (@CashFlowAccount_ID, @CashFlowAccount_Desc, @Stamp_UserID, @Stamp_DateTim"& _ 
                "e, @Upload_DateTime, @RecordStatus_ID);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CashFlowAccount_ID, CashFlowAcco"& _ 
                "unt_Desc, Stamp_UserID, Stamp_DateTime, Upload_DateTime, RecordStatus_ID FROM Ac"& _ 
                "counting_CashFlowAccount WHERE (CashFlowAccount_ID = @CashFlowAccount_ID)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CashFlowAccount_ID", Global.System.Data.SqlDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CashFlowAccount_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Accounting_CashFlowAccount] SET [CashFlowAccount_ID] = @CashFlowAccount_I"& _ 
                "D, [CashFlowAccount_Desc] = @CashFlowAccount_Desc, [Stamp_UserID] = @Stamp_UserI"& _ 
                "D, [Stamp_DateTime] = @Stamp_DateTime, [Upload_DateTime] = @Upload_DateTime, [Re"& _ 
                "cordStatus_ID] = @RecordStatus_ID WHERE (([CashFlowAccount_ID] = @Original_CashF"& _ 
                "lowAccount_ID) AND ([CashFlowAccount_Desc] = @Original_CashFlowAccount_Desc) AND"& _ 
                " ((@IsNull_Stamp_UserID = 1 AND [Stamp_UserID] IS NULL) OR ([Stamp_UserID] = @Or"& _ 
                "iginal_Stamp_UserID)) AND ((@IsNull_Stamp_DateTime = 1 AND [Stamp_DateTime] IS N"& _ 
                "ULL) OR ([Stamp_DateTime] = @Original_Stamp_DateTime)) AND ((@IsNull_Upload_Date"& _ 
                "Time = 1 AND [Upload_DateTime] IS NULL) OR ([Upload_DateTime] = @Original_Upload"& _ 
                "_DateTime)) AND ((@IsNull_RecordStatus_ID = 1 AND [RecordStatus_ID] IS NULL) OR "& _ 
                "([RecordStatus_ID] = @Original_RecordStatus_ID)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CashFlowAccount_ID, C"& _ 
                "ashFlowAccount_Desc, Stamp_UserID, Stamp_DateTime, Upload_DateTime, RecordStatus"& _ 
                "_ID FROM Accounting_CashFlowAccount WHERE (CashFlowAccount_ID = @CashFlowAccount"& _ 
                "_ID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CashFlowAccount_ID", Global.System.Data.SqlDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CashFlowAccount_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     CashFlowAccount_ID, CashFlowAccount_Desc, Stamp_UserID, Stamp_DateTime"& _ 
                ", Upload_DateTime, RecordStatus_ID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Accounting_CashFlowAccount"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_CashFlowAccount_ID As Short, ByVal Original_CashFlowAccount_Desc As String, ByVal Original_Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Original_Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Original_Upload_DateTime As Global.System.Nullable(Of Date), ByVal Original_RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_CashFlowAccount_ID,Short)
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(1).Value = CType(Original_CashFlowAccount_Desc,String)
            End If
            If (Original_Stamp_UserID.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_Stamp_UserID.Value,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal CashFlowAccount_ID As Short, ByVal CashFlowAccount_Desc As String, ByVal Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Upload_DateTime As Global.System.Nullable(Of Date), ByVal RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(CashFlowAccount_ID,Short)
            If (CashFlowAccount_Desc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CashFlowAccount_Desc")
            Else
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(CashFlowAccount_Desc,String)
            End If
            If (Stamp_UserID.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(Stamp_UserID.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CashFlowAccount_ID As Short, ByVal CashFlowAccount_Desc As String, ByVal Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Upload_DateTime As Global.System.Nullable(Of Date), ByVal RecordStatus_ID As Global.System.Nullable(Of Integer), ByVal Original_CashFlowAccount_ID As Short, ByVal Original_CashFlowAccount_Desc As String, ByVal Original_Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Original_Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Original_Upload_DateTime As Global.System.Nullable(Of Date), ByVal Original_RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(CashFlowAccount_ID,Short)
            If (CashFlowAccount_Desc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CashFlowAccount_Desc")
            Else
                Me.Adapter.UpdateCommand.Parameters(1).Value = CType(CashFlowAccount_Desc,String)
            End If
            If (Stamp_UserID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Stamp_UserID.Value,Integer)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_CashFlowAccount_ID,Short)
            If (Original_CashFlowAccount_Desc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CashFlowAccount_Desc")
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_CashFlowAccount_Desc,String)
            End If
            If (Original_Stamp_UserID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_Stamp_UserID.Value,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CashFlowAccount_Desc As String, ByVal Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Upload_DateTime As Global.System.Nullable(Of Date), ByVal RecordStatus_ID As Global.System.Nullable(Of Integer), ByVal Original_CashFlowAccount_ID As Short, ByVal Original_CashFlowAccount_Desc As String, ByVal Original_Stamp_UserID As Global.System.Nullable(Of Integer), ByVal Original_Stamp_DateTime As Global.System.Nullable(Of Date), ByVal Original_Upload_DateTime As Global.System.Nullable(Of Date), ByVal Original_RecordStatus_ID As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_CashFlowAccount_ID, CashFlowAccount_Desc, Stamp_UserID, Stamp_DateTime, Upload_DateTime, RecordStatus_ID, Original_CashFlowAccount_ID, Original_CashFlowAccount_Desc, Original_Stamp_UserID, Original_Stamp_DateTime, Original_Upload_DateTime, Original_RecordStatus_ID)
        End Function
    End Class
End Namespace
