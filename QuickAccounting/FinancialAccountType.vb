...
#Region "Declarations"
  Private _FinancialAccountTypeTableAdapterObject As New FinancialAccountTypeTableAdapter
  Private _CompanyTableAdapterObject As New CompanyTableAdapter
  Private _FinancialAccountTypeDataTable As New FinancialAccountTypeDataTable
  Private _CurrentFinancialAccountTypeDataRow As FinancialAccountTypeRow
#End Region
    ...
    Try
      If IsValid() Then
        If Me._CurrentFinancialAccountTypeDataRow Is Nothing Then
          _CurrentFinancialAccountTypeDataRow = Me._FinancialAccountTypeDataTable.NewFinancialAccountTypeRow
